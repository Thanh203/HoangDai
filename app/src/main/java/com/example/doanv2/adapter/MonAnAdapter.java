...
public class MonAnAdapter extends RecyclerView.Adapter<MonAnAdapter.MonAnVH>{
    ArrayList<MonAnDonGian> cacMonAn;
    Context context;
    ItemCallback itemCallback;
    public MonAnAdapter(ArrayList<MonAnDonGian> cacMonAn,Context context ,ItemCallback itemCallback) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MonAnVH holder, int position) {
